...
const dataArr = [
    {title: 'Задача1', description: 'Описание задачи 1.Описание задачи 1', createdAt: '2021-07-27 12:00:00',
        updatedAt: '2021-07-27 12:00:00', endingAt: '2021-08-01', priority: 3, status: 3,creator: 1, responsible: 2},
    {title: 'Задача2', description: 'Описание задачи 2.Описание задачи 2', createdAt: '2021-07-27 15:00:00',
        updatedAt: '2021-07-28 15:00:00', endingAt: '2021-08-05', priority: 1, status: 4,creator: 2, responsible: 2},
    {title: 'Задача3', description: 'Описание задачи 3.Описание задачи 3', createdAt: '2021-07-25 21:00:00',
        updatedAt: '2021-05-28 21:00:00', endingAt: '2021-07-28', priority: 2, status: 2,creator: 3, responsible: 4},
    {title: 'Задача4', description: 'Описание задачи 4.Описание задачи 4', createdAt: '2021-07-22 11:00:00',
        updatedAt: '2021-08-28 21:00:00', endingAt: '2021-07-27', priority: 3, status: 1,creator: 4, responsible: 4},
    {title: 'Задача5', description: 'Описание задачи 5.Описание задачи 5', createdAt: '2021-07-22 23:00:00',
        updatedAt: '2021-07-22 23:00:00', endingAt: '2021-07-29', priority: 3, status: 3,creator: 1, responsible: 6},
    {title: 'Задача6', description: 'Описание задачи 6.Описание задачи 6', createdAt: '2021-07-22 14:35:00',
        updatedAt: '2021-07-22 14:35:00', endingAt: '2021-07-26', priority: 2, status: 3,creator: 6, responsible: 6},
]
